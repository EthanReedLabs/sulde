...
| --- | --- |
| Historical v0.1.x | Existing MIT grants remain effective; see the [MIT archive](../LICENSE-v0.1.0-MIT-archive) |
| Copies distributed under BSL 1.1 before this change | Their original BSL conditions and change-license rights remain effective; see the [archived declaration](../LICENSE-BSL-1.1-archive) |
